...
namespace GestaoMais.Web.Controllers.Sistema
{
    public class TipoPessoasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Descricao,Id,DataCriacao")] TipoPessoa tipoPessoa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Descricao,Id,DataCriacao")] TipoPessoa tipoPessoa)
        {
            if (id != tipoPessoa.Id)
            {
                return NotFound();
