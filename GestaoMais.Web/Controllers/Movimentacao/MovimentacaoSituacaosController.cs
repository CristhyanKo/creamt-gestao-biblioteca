...
namespace GestaoMais.Web.Controllers.Movimentacao
{
    public class MovimentacaoSituacaosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Nome,Id,DataCriacao")] MovimentacaoSituacao movimentacaoSituacao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Nome,Id,DataCriacao")] MovimentacaoSituacao movimentacaoSituacao)
        {
